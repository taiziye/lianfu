        ...
        new NetConnection(new NetConnection.SuccessCallback() {
            ...
            public void onSuccess(JSONObject result) {
                ...
                try {
                    ...
                    Intent intent = new Intent(RelateActivity.this, HomePageActivity.class);
            ...
            public void onFail(JSONObject result) {
                ...
                try {
                    ...
                    if(status.equals("2")){
                        ToastUtils.showToast(RelateActivity.this,getString(R.string.username_or_pwd_error), Toast.LENGTH_SHORT);
                    }else if(status.equals("3")){
                        ToastUtils.showToast(RelateActivity.this,getString(R.string.account_not_exist),Toast.LENGTH_SHORT);
                    }else {
                        ToastUtils.showToast(RelateActivity.this,getString(R.string.server_exception),Toast.LENGTH_SHORT);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
