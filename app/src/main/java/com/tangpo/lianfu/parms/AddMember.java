...
public class AddMember {
    public static final String packagingParam(Context context,String...kvs){
        ...
        try {
            ...
            paramJsonObject.put("pw", Escape.escape(kvs[2]));
            paramJsonObject.put("phone", Escape.escape(kvs[3]));
            paramJsonObject.put("service_center", Escape.escape(kvs[4]));
            paramJsonObject.put("service_address", Escape.escape(kvs[5]));
            paramJsonObject.put("referrer", Escape.escape(kvs[6]));
            paramJsonObject.put("sex", Escape.escape(kvs[7]));
            paramJsonObject.put("birth", Escape.escape(kvs[8]));
            paramJsonObject.put("qq", Escape.escape(kvs[9]));
            paramJsonObject.put("email", Escape.escape(kvs[10]));
            paramJsonObject.put("address", Escape.escape(kvs[11]));
            paramJsonObject.put("bank_account", Escape.escape(kvs[12]));
